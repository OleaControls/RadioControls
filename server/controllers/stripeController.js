...
export const cancelSubscription = async (req, res) => {
  ...
  try {
    ...
    // Mantenemos ACTIVE porque el acceso sigue hasta el fin del período.
    // El webhook 'customer.subscription.deleted' actualizará a CANCELED cuando realmente expire.
